...
export default class ErrorBoundary extends Component {
  ...
  componentDidCatch(err) { console.error('OPEN-GYM_TRAINER render error:', err) }
  ...
  render() {
    ...
    return (
      <div className="narrow">
        ...
        <Button variant="primary" icon="reset" onClick={() => location.reload()}>{t('Reload OPEN-GYM_TRAINER')}</Button>
        {active && <>
          <div style={{ height: 8 }} />
